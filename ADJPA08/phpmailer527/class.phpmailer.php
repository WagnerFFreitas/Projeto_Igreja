...
class PHPMailer
{
    ...
    public static function validateAddress($address, $patternselect = 'auto')
    {
        ...
        switch ($patternselect) {
            case 'pcre8':
                /**
                 * Em conformidade com a RFC5322: Usa * correto * regex no qual FILTER_VALIDATE_EMAIL é
                 * Sediada; Então, por que não usar FILTER_VALIDATE_EMAIL? Porque foi quebrado para
                 * não permite um endereço válido do tipo @ b :(
                 * @link http://squiloople.com/2009/12/20/email-address-validation/
                 * @copyright 2009-2010 Michael Rushton
                 * Sinta-se à vontade para usar e redistribuir este código. Mas por favor, mantenha este aviso de direitos autorais.
                 */
