...
function actualiza(miColor,miColor2){
	...
	window.opener.document.forms[0].<?PHP echo $campo;?>.value = miColor
	window.opener.document.forms[0].<?PHP echo $rol;?>.value = miColor2
}
</script>
<style type="text/css">
<!--
...
if (!empty($_GET['nome']))
	{
		...
		$nmpp="800"; //N�mero de mensagens por p�rginas
		$paginacao = Array();
		...
		<?PHP
            ...
            <tr "<?php echo "$cor";?>">
				...
				<script>
					...
					document.write( "<img border='0' src=../img_membros/<?PHP echo $coluna["rol"];?>.jpg align='absbottom' title='"+nome+"'>" );
				</script>
				</td>
