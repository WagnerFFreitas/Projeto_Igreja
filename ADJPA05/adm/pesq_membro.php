...
$campo = $_GET["campo"];
$rol = $_GET["rol"];
$form = (int)$_GET["form"];//O n�mero da seq�ncia do formul�rio se o 1 para 1�, 2 para 2�..., dentro da p�gina
//echo " - $form - ";
?>
...
if (!empty($_GET['nome']))
	{
		...
		$nmpp="4"; //N�mero de mensagens por p�rginas
		$paginacao = Array();
		...
		if ($pagina<1) {$pagina=0;} //Especifica um valor p vari�vel p�gina caso ela esteja setada
