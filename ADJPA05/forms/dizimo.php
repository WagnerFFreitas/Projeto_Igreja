...
<form id="form1" name="form1" method="post" action="">
	...
	<a href="javascript:lancarSubmenu('campo=nome&rol=rol_d&form=0')"><img border="0" src="img/lupa_32x32.png" width="18" height="18" title="Click aqui para pesquisar membros!" /></a>
  ...
  <input name="escolha" type="hidden" value="tesouraria/dizimo.php" />
</form>
</fieldset>
